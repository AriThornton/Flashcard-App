      ...
      <div className='container'>
        <Switch>
          <Route path='/decks/new'>
            <CreateDeck deckList={deckList} createDeckHandler={createDeckHandler} />
          </Route>
          <Route path='/decks/:deckId/study'>
            <StudyDeck selectedDeck={selectedDeck} setSelectedDeck={setSelectedDeck} />
          </Route>
          <Route path='/decks/:deckId/edit'>
            <EditDeck selectedDeck={selectedDeck} setSelectedDeck={setSelectedDeck} />
          </Route>
